import React, { useCallback, useEffect, useReducer, useCallback } from 'react'; // useReducer 是可以将读入的内容分发的控件 与 redux reducer 无关
import {
    View,
    StyleSheet,
    Text,
        ...
        <ScrollView>
            <View style={styles.form}>
                <Input
                    ...
                    onInputChange={inputChangeHandler.bind(this, 'title')} //这里不用 再bind text因为react native 会自动将
