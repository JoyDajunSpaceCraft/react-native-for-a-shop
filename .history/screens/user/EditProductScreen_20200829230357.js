...
const EditProductScreen = props => {
    ...
    const [title, setTitle] = useState(editProdcut ? editProdcut.title : ' ');
    const [imageUrl, setImageUrl] = useState(editProdcut ? editProdcut.imageUrl : '');
    const [price, setPrice] = useState('');//已经出现的商品的价格不能被再次修改
    const [description, setDescription] = useState(editProdcut ? editProdcut.description : '');
